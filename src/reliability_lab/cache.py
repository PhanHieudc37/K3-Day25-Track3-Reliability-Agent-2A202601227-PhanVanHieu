...
class ResponseCache:
    ...
    Uses semantic similarity and false-hit guardrails.
    ...
    def set(self, query: str, value: str, metadata: dict[str, str] | None = None) -> None:
        ...
        Storage behavior with privacy guardrail:
...
class SharedRedisCache:
    ...
    The get() and set() methods use Redis commands
    ...
    def ping(self) -> bool:
        ...
        except Exception:  # noqa: BLE001 - connectivity probe must degrade to False
            return False
    ...
    def set(self, query: str, value: str, metadata: dict[str, str] | None = None) -> None:
        ...
        if metadata:
            mapping.update({f"metadata:{name}": item for name, item in metadata.items()})
